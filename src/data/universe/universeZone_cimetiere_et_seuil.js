export const zoneCimetiereEtSeuil = {
  ...
  summary:
    "Nécropole en terrasses reliées par des escaliers étroits, seuil vers la Spirale.",
  details: [
  ...
  locations: [
    {
      ...
      details: [
        ...
        "Danger : Pilleurs de tombes, morts-vivants, gardes nerveux.",
    ...
    },
    {
      ...
      details: [
        ...
        "Danger : Chevaliers morts-vivants, gardiens de l'ancien ordre.",
    ...
    },
    {
      ...
      summary:
        "Passerelle étroite reliant deux terrasses funéraires, piégée par les nécromanciens.",
      details: [
    ...
    },
    {
      ...
      summary:
        "Ouverture verticale noire où l'on ressent l'appel de la Spirale.",
      details: [
