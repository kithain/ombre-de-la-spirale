export const zoneCimetiereEtSeuil = {
  ...
  details: [
    "Le cimetière est construit en terrasses étroites retenues par d’épais murs de granit. Des escaliers de pierre relient les différents niveaux, chacun réservé à un clan, une lignée ou une ancienne confrérie de mineurs.",
  ...
  emplacements: [
    {
      ...
      details: [
        "Les sept tombes sont fermées par de lourdes dalles de granit sombre posées sur un soubassement profondément ancré dans la colline. Les pierres sont parfaitement ajustées, sans mortier visible ni serrure accessible.",
    ...
    },
    {
      ...
      resume:
        "Sous la dalle centrale du mausolée se trouve un ancien puits vertical taillé dans la roche. Son ouverture est habituellement dissimulée et les prêtres du Temple-Forgeron n’en connaissent plus l’usage exact.",
      details: [
