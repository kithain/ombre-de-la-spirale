export const zoneProfondeursMine = {
  ...
  summary:
    "Réseau de galeries profondes, poumon économique et porte brisée vers la Spirale.",
  details: [
  ...
  locations: [
    {
      ...
      details: [
        ...
        "Danger : Monstres fouisseurs, créatures attirées par la magie de la Spirale.",
    ...
    },
    {
      ...
      summary:
        "Niveaux -1 à -7 abandonnés après les premiers hurlements de la pierre.",
      details: [
        ...
        "Danger : Monstres rouilleurs, ankhegs, morts oubliés.",
