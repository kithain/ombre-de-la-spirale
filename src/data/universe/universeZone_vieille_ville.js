export const zoneVieilleVille = {
  ...
  name: "Vieille Ville",
  summary:
    "Quartier le plus ancien, labyrinthe de ruelles étroites et de maisons penchées.",
  details: [
  ...
  locations: [
    {
      ...
      details: [
        ...
        "Danger : Bandits, espions, créatures tapis dans l'ombre.",
    ...
    },
    {
      ...
      summary:
        "Grande auberge de bois sombre, point de départ idéal de la campagne.",
      details: [
        ...
        "Danger : Ivrognes agressifs, collecteurs de dettes.",
