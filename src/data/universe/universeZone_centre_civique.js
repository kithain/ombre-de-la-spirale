export const zoneCentreCivique = {
  ...
  name: "Centre Civique",
  summary:
    "Cœur administratif de Valombre, siège du pouvoir civil et judiciaire.",
  details: [
  ...
  locations: [
    {
      id: "hotel_de_ville_valombre",
      name: "Hôtel de Ville de Valombre",
      summary:
        "Siège administratif et salle du Conseil, cœur des décisions politiques.",
      details: [
        ...
        "Danger : Gardes du Conseil, mages assermentés, complots de Thade.",
    ...
    },
    {
      ...
      summary:
        "Salle ovale aux vitraux rouges où se réunissent les dirigeants lors des crises.",
      details: [
    ...
    },
    {
      ...
      summary:
        "Esplanade officielle où se tiennent discours et rassemblements.",
      details: [
        ...
        "Danger : Gardes du Conseil, agitateurs payés, agents de Thade.",
        "Usage : Scènes de crise politique, déclarations de loi martiale, exécutions publiques.",
      ],
      npcIds: ["capitaine_garde_urbaine"],
    },
    {
      id: "rues_valombre_nuit",
      name: "Rues de Valombre (nuit)",
      summary:
        "Réseau de ruelles plongées dans la brume, patrouillées par les forces du Conseil.",
      details: [
        "Ambiance : Brume lourde, lanternes sporadiques, cris étouffés.",
        "Danger : Patrouilles mixtes (gardiens, golems de chair), embuscades.",
    ...
    {
      id: "rues_valombre_brume",
      name: "Rues Brumeuses Réanimées",
      summary:
        "Artères noyées de brume violette où les cadavres se relèvent instantanément.",
      details: [
    ...
    },
    {
      ...
      summary:
        "Bloc de pierre sans fenêtres, symbole de la répression politique.",
      details: [
        ...
        "Danger : Geôliers brutaux, interrogateurs, mages assermentés.",
