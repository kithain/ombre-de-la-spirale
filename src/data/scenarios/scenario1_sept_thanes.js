...
export const scenario1 = {
  ...
  vue_ensemble: {
    ton:
      "Enquête qui s'assombrit. On commence dans l'atmosphère confiante d'un mandataire de l'Université, puis on bascule vers le mystère, la suspicion et l'horreur douce d'une cité qui ne sait pas ce qu'elle garde.",
    themes: [
  ...
  fronts_actifs: [
    {
      ...
      interactions_scenes: [
        ...
        },
        {
          ...
          interaction:
            "Olane révèle que les flux sont détournés vers la Tour. Si les PJ la protègent, l'horloge ralentit. S'ils l'ignorent, Thade accélère son isolement.",
        },
      ],
      leviers_pj_scenario:
  ...
  aides_jeu: {
    ...
    preuves_transportables: [
      {
        objet: "Carnet de Jaren Velt",
        scene: "La Mort de Jaren Velt",
        type: "Physique — emportable",
        description: "Carnet avec pages arrachées, cachet de Caldris, écriture inconnue sur les pages restantes.",
        utilisable_pour: "Prouver le lien entre Jaren, Caldris et l'extérieur. Présenter au Conseil ou à Olane.",
      },
      {
        objet: "Fragment d'os avec runes d'ancrage",
        scene: "Première Descente aux Terrasses",
        type: "Physique — emportable",
        description: "Ossement prélevé portant des runes gravées. Pas des décorations — des points de fixation rituelle.",
        utilisable_pour: "Prouver que les tombes sont un système actif. Présenter à Thorgar ou au Conseil.",
      },
      {
        objet: "Ciselets d'Université",
        scene: "Première Descente aux Terrasses",
        type: "Physique — emportable",
        description: "Outils de précision d'Université trouvés sur les tombes. Pas des outils de vandale.",
        utilisable_pour: "Prouver l'implication de l'Université. Présenter au Conseil ou à Olane.",
      },
      {
        objet: "Dossier S-01 (copie partielle)",
        scene: "Les Archives Médicales Scellées",
        type: "Physique — copie, emportable",
        description: "Dossier médical de Sealine Vael (Coren, S. — 12-VAEL). S-01 = Sealine, premier patient. Protocole établi 28 jours avant Nyx.",
        utilisable_pour: "Prouver que Thade explorait la littérature interdite avant la catastrophe. Présenter au Conseil ou à Olane.",
      },
      {
        objet: "Témoignage d'Olane sur les flux détournés",
        scene: "Le Bureau d'Olane",
        type: "Témoignage — formalisable par écrit",
        description: "Olane confirme que les flux arcaniques de l'Université sont détournés vers la Tour par quelqu'un avec un accès de haut niveau.",
        utilisable_pour: "Prouver l'utilisation des ressources de l'Université. Olane peut le formaliser si les PJ le demandent.",
      },
      {
        objet: "Caisses d'os marquées Caldris",
        scene: "La Rencontre avec la Résistance",
        type: "Physique — trop grandes pour transporter, mais preuve par description/témoignage",
        description: "Caisses d'os dans les égouts. Cachet de Caldris et marquage d'Université. Convergent vers la Tour.",
        utilisable_pour: "Prouver le circuit physique des ossements. Le Collecteur ou Sniv peuvent témoigner.",
      },
    ],
    ...
    pnj_allies: [
      {
        ...
        disponibilite: "Dès la scène 2. Toujours disponible aux Terrasses.",
        apporte: "Connaissance des rites d'Edhrek-Murn. Peut restaurer le sceau si les PJ lui apportent les runes correctes.",
        mobilisable: "Peut accompagner les PJ au Cimetière pour les rites. Pas un combattant, mais un rituel.",
      },
      {
        id: "maera_olane",
        nom: "Maëra Olane",
        lieu: "Université — Salle 4B",
        disponibilite: "Dès l'Acte II. S'ouvre si les PJ apportent des preuves.",
        apporte: "Accès institutionnel, données sur les flux, couverture pour infiltrer les Archives. Pont vers le Conseil.",
        mobilisable: "Peut porter la voix des PJ au Conseil. Peut fournir un accès à la Réserve Interdite (Scénario 2).",
      },
      {
        id: "mara_dirigeante",
        nom: "Mara",
        lieu: "Maison des Retours, Vieille Ville",
        disponibilite: "Dès l'Acte III. Accessible via la Résistance.",
        apporte: "Réseau clandestin, accès aux égouts, connaissances sur Nyx. Alternative à l'Université.",
        mobilisable: "Peut envoyer Sniv ou le Collecteur accompagner les PJ. Peut mobiliser des éclaireurs.",
      },
      {
        id: "le_collecteur",
        nom: "Le Collecteur",
        lieu: "Via Mara — égouts",
        disponibilite: "Dès l'Acte III. Contact via Mara.",
        apporte: "Informations sur le circuit des caisses d'os. Horaires et pistes.",
        mobilisable: "Peut guider les PJ dans les égouts jusqu'aux caisses. Transactionnel — paie en informations.",
      },
      {
        id: "sniv_kobold",
        nom: "Sniv",
        lieu: "Via Mara — égouts",
        disponibilite: "Dès l'Acte III. Contact via Mara.",
        apporte: "Connaissance des passages souterrains. Peut montrer les passages creusés récents.",
        mobilisable: "Peut accompagner les PJ dans les égouts. Loyal si respecté. Utile pour l'infiltration.",
      },
      {
        id: "ursula_fraternite",
        nom: "Ursula",
        lieu: "Maison des Retours, Vieille Ville",
        disponibilite: "Dès l'Acte III (ou scène optionnelle).",
        apporte: "Soins pour les malades ignorés. Témoignage sur les symptômes similaires à ceux de Sealine.",
        mobilisable: "Peut soigner les PJ. Peut témoigner des symptômes au Conseil ou à Olane.",
      },
    ],
    ...
    symptomes_fronts: [
      {
        ...
        symptomes: [
          { etape: "1 segment", signe: "Froid anormal au cimetière. Lanternes funéraires qui s'éteignent." },
          { etape: "2 segments", signe: "Vibrations dans les galeries de la mine. Mineurs refusent de descendre." },
          { etape: "3 segments", signe: "Cinq tombes sur sept touchées. Runes qui changent sur les dalles." },
          { etape: "4 segments", signe: "Déphasage visible dans la Vieille Ville. Distances trompeuses. Le sceau cède." },
        ],
      },
      {
        front: "Le Plan de Thade",
        symptomes: [
          { etape: "1 segment", signe: "Outils d'Université sur les tombes. Quelqu'un prélève avec précision." },
          { etape: "2 segments", signe: "Jaren surveille les PJ, puis meurt. Les notes disparaissent." },
          { etape: "3 segments", signe: "Flux arcaniques détournés vers la Tour. Olane le confirme." },
          { etape: "4 segments", signe: "Caisses d'os convergent vers la Tour. Le rituel est en préparation." },
        ],
      },
    ],
    ...
    consequences_choix: [
      {
        choix: "Rejoindre la Résistance (Mara)",
        consequence_immediate: "Accès aux égouts, au réseau clandestin, aux soins d'Ursula. Mara partage ce qu'elle sait sur Nyx.",
        consequence_long_terme: "Ennemis à l'Université. Thade sait que les PJ ont changé de camp. Olane reste accessible mais prudente.",
        impact_front: "Le front 'Le Plan de Thade' accélère — Thade prélève sans enquêteurs. Le front 'Le Sceau qui cède' avance sans surveillance.",
      },
      {
        choix: "Rester avec Thade",
        consequence_immediate: "Mandat officiel, ressources de l'Université, accès institutionnel. Thade continue de prélèver pendant que les PJ enquêtent.",
        consequence_long_terme: "Le doute grandit. Les PJ servent l'antagoniste sans le savoir. Olane se méfie.",
        impact_front: "Le front 'Le Plan de Thade' avance — Thade utilise les rapports des PJ pour couvrir ses prélèvements.",
      },
      {
        choix: "Confronter Thade",
        consequence_immediate: "Relation tendue. Thade retourne l'accusation en mandat. L'Université protège Thade par confiance.",
        consequence_long_terme: "Thade surveille les PJ. Olane devient la seule alliée institutionnelle. Les PJ doivent collecter des preuves.",
        impact_front: "Le front 'Le Plan de Thade' ralentit — Thade est plus prudent. Mais le front 'Le Sceau qui cède' continue.",
      },
      {
        choix: "Troisième voie (Olane)",
        consequence_immediate: "Pont entre l'institution et la vérité. Accès aux Archives, aux données, à la couverture.",
        consequence_long_terme: "Olane est vulnérable. Si elle est arrêtée, les PJ perdent tout soutien institutionnel.",
        impact_front: "Les deux fronts avancent à vitesse normale. Les PJ ont un avantage d'information.",
      },
    ],
  },
      ...
      scenes: [
        {
          ...
          navigation: {
            indice_indispensable: "Les PJ doivent savoir que Thade les envoie au Cimetière et que les profanations ciblent les tombes des Sept Thanes.",
            consequence_si_manque: "Sans cette information, les PJ n'ont aucun point d'ancrage. Thade trouve un autre prétexte pour les envoyer au Cimetière, ou le Conseil publie un avis d'enquête officielle.",
            pnj_alternatifs: [],
            front_si_ignore: "Le Sceau qui cède — une nouvelle tombe est profanée chaque semaine sans enquête.",
            scenes_alternatives: [],
            sorties_jouables: [
              {
                condition: "Les PJ acceptent la mission et se rendent au Cimetière",
                sceneId: "s1_premiere_descente",
                type: "indice_principal",
                moteur: "L'ordre de mission donne accès aux Terrasses. Thade les y envoie.",
                accroche_mj: "« Thade vous remet l'ordre de mission. Le Cimetière des Terrasses est au flanc nord de la colline. Un prêtre nain nommé Thorgar y garde les tombes. »",
                consequence_si_refus: "Si les PJ refusent, Thade n'insiste pas. Le lendemain, le Conseil publie un avis — les PJ se retrouvent sans accès au Cimetière. Ils devront trouver un autre moyen d'y entrer.",
              },
              {
                condition: "Les PJ demandent à voir le Cimetière de nuit immédiatement",
                sceneId: "s1_premiere_descente",
                type: "lieu",
                moteur: "Les PJ veulent voir les lieux sans attendre.",
                accroche_mj: "« Thade hausse un sourcil. Vous voulez y aller maintenant ? C'est la nuit. Thorgar y est, lui. Allez-y. »",
                consequence_si_refus: "Thade ne les retient pas. La scène s1_premiere_descente se joue de nuit avec une ambiance plus tendue.",
              },
              {
                condition: "Les PJ refusent la mission",
                sceneId: "s1_premiere_descente",
                type: "echec",
                moteur: "Refus de l'offre. Thade ne insiste pas.",
                accroche_mj: "« Très bien. Je comprends. Mais le Conseil publiera un avis demain. Si vous changez d'avis, l'offre reste ouverte. » Le lendemain, les PJ n'ont plus d'accès officiel au Cimetière.",
                consequence_si_refus: "Les PJ doivent trouver un autre moyen d'accéder au Cimetière (Discrétion, contacts nains, ou attendre que la crise s'aggrave).",
              },
              {
                condition: "Le front 'Le Sceau qui cède' est à 2+ segments",
                sceneId: "s1_premiere_descente",
                type: "urgence_front",
                moteur: "Une nouvelle tombe a été profanée cette nuit. Thade est pressé.",
                accroche_mj: "Thade vous reçoit avec une urgence inhabituelle. « Une quatrième tombe a été touchée cette nuit. La situation s'aggrave. Il faut y aller maintenant. »",
                consequence_si_refus: "Si les PJ tardent, une cinquième tombe sera touchée. Le sceau se rapproche de la rupture.",
              },
              {
                condition: "Les PJ veulent explorer la ville avant d'aller au Cimetière",
                sceneId: "s1_premiere_descente",
                type: "libre",
                moteur: "Les PJ veulent prendre leurs marques dans Valombre.",
                accroche_mj: "« Vous avez l'ordre de mission. Le Cimetière n'attendra pas, mais vous êtes libres de vos mouvements. Thorgar est aux Terrasses de jour comme de nuit. »",
                consequence_si_refus: "Le temps perdu avance les fronts. Une tombe de plus est touchée si les PJ attendent plus d'un jour.",
              },
            ],
            fallback_mj: "Cette scène est un entonnoir volontaire : tout mène au Cimetière. Si les PJ refusent, Thade trouve un autre vecteur (Conseil, rumeur, incident). La scène ne peut pas être évitée — seulement retardée.",
            objectif_scene: "Accepter ou refuser la mission de Thade pour enquêter sur les profanations du Cimetière des Terrasses.",
            pression: "Une nouvelle tombe est profanée chaque semaine. Plus les PJ attendent, plus le sceau cède. Si les PJ refusent, le Conseil publie un avis et les PJ perdent l'accès officiel.",
            actions_pj_attendues: ["discuter avec Thade", "poser des questions sur Nyx et les profanations", "accepter ou refuser la mission", "explorer le bureau (coffret, parfum)"],
            sorties_possibles: ["vers s1_premiere_descente (accepter la mission)", "vers s1_premiere_descente (refuser — accès bloqué, autre voie nécessaire)"],
            si_les_pj_bloquent: "Thade ne insiste pas. Le lendemain, le Conseil publie un avis d'enquête officielle. Les PJ se retrouvent sans accès au Cimetière. Un incident (tombe profanée en plein jour) peut les relancer.",
            conditions_sortie: [
              "Les PJ acceptent la mission et prennent l'ordre de mission.",
              "OU les PJ refusent et le Conseil publie un avis le lendemain.",
              "OU les PJ quittent le bureau sans décider — Thade envoie un message le lendemain.",
            ],
            transition_defaut: "Thade raccompagne les PJ à la porte. « Réfléchissez. Mais pas trop longtemps. » Le lendemain, un messager de l'Université apporte une lettre scellée : rappel de l'offre.",
          },
        },

        {
          ...
          navigation: {
            indice_indispensable: "Les PJ doivent comprendre que les profanations ciblent les Thanes et que les outils viennent de l'Université.",
            consequence_si_manque: "Sans identifier les outils d'Université, les PJ manquent le lien institutionnel. Thorgar peut le signaler si les PJ lui montrent les marques. Le carnet de Jaren reste accessible plus tard.",
            pnj_alternatifs: ["thorgar_pretre_nain — peut identifier les marques d'outils si les PJ lui montrent", "jaren_velt — son carnet contient le cachet de Caldris, accessible même après sa mort"],
            front_si_ignore: "Le Sceau qui cède — les prélèvements continuent. Le Plan de Thade — Jaren transmet ses notes.",
            scenes_alternatives: ["s1_temple_forgeron — si les PJ vont voir Thorgar directement après le Cimetière"],
            sorties_jouables: [
              {
                condition: "Les PJ suivent la piste des outils d'Université et du carnet de Jaren",
                sceneId: "s1_mort_jaren",
                type: "indice_principal",
                moteur: "Le lendemain ou le surlendemain, Jaren est retrouvé mort. La campagne bascule.",
                accroche_mj: "« Le lendemain matin, on frappe à votre porte. Un message glissé sous la porte : 'Pavillon Nord. Troisième étage. Venez vite.' »",
                consequence_si_refus: "Si les PJ ignorent le message, la garde trouve le corps en premier. Le carnet est confisqué. Les PJ perdent l'accès aux indices de la scène.",
              },
              {
                condition: "Les PJ vont voir Thorgar au Temple-Forgeron pour comprendre les runes",
                sceneId: "s1_temple_forgeron",
                type: "pnj",
                moteur: "Thorgar connaît les gestes mais pas leur sens. Il peut identifier les runes d'ancrage.",
                accroche_mj: "« Thorgar vous regarde avec ses yeux fatigués. 'Si vous voulez comprendre ce que ces runes signifient, venez au Temple. Sous la forge. Je vous montrerai ce que je sais.' »",
                consequence_si_refus: "Les PJ peuvent reportent cette visite. Mais Thorgar est essentiel pour comprendre le système d'ancrage.",
              },
              {
                condition: "Les PJ demandent à voir le Mausolée du Seuil",
                sceneId: "s1_mort_jaren",
                type: "lieu",
                moteur: "Le Mausolée vibre. Le froid planaire est perceptible. Les PJ sentent l'urgence.",
                accroche_mj: "« La dalle centrale vibre sous vos pieds. Le bourdonnement du Puits de l'Abîme est audible. L'air est plus froid ici que partout ailleurs au Cimetière. »",
                consequence_si_refus: "Si les PJ n'entrent pas dans le Mausolée, ils ne ressentent pas le froid planaire. L'urgence est moins palpable mais Thorgar peut le décrire plus tard.",
              },
              {
                condition: "Les PJ échouent leurs jets d'investigation et ne trouvent rien",
                sceneId: "s1_mort_jaren",
                type: "echec",
                moteur: "Thade les renvoie enquêter plus profondément. Pendant ce temps, Jaren meurt.",
                accroche_mj: "« Thade vous reçoit avec courtoisie. 'Rien d'utile ? Continuez. Le Cimetière est grand. Revenez demain.' Le lendemain, Jaren est mort. »",
                consequence_si_refus: "Les PJ arrivent après la garde. Le carnet est confisqué. Ils doivent trouver un autre moyen d'accéder aux indices.",
              },
              {
                condition: "Le front 'Le Plan de Thade' avance — Jaren a trop vu",
                sceneId: "s1_mort_jaren",
                type: "urgence_front",
                moteur: "Thade fait tuer Jaren parce qu'il posait des questions sur S-01.",
                accroche_mj: "« Le lendemain à l'aube, un message anonyme. Pavillon Nord. Troisième étage. L'air sent la lavande. Jaren est mort. »",
                consequence_si_refus: "La scène se déclenche automatiquement. Les PJ ne peuvent pas empêcher la mort de Jaren.",
              },
              {
                condition: "Les PJ veulent explorer la Vieille Ville ou les égouts",
                sceneId: "s1_mort_jaren",
                type: "libre",
                moteur: "Les PJ cherchent d'autres pistes avant de retourner au Cimetière.",
                accroche_mj: "« Vous avez le soir pour vous. La Vieille Ville est un labyrinthe de ruelles. Le Cimetière est au flanc de la colline, au nord. » Pendant ce temps, Jaren meurt.",
                consequence_si_refus: "Les PJ perdent le carnet de Jaren si la garde trouve le corps en premier.",
              },
            ],
            fallback_mj: "La mort de Jaren est un pivot narratif qui se déclenche automatiquement dans les 1-2 jours suivant la première descente. Si les PJ sont ailleurs, ils entendent la nouvelle. Le carnet peut être confisqué, mais les indices (rune, lavande, pages arrachées) restent accessibles sur le corps avant que la garde ne nettoie la scène.",
            objectif_scene: "Examiner les tombes profanées, identifier les outils d'Université, rencontrer Thorgar et Jaren, ressentir l'anomalie du Mausolée.",
            pression: "Les prélèvements d'os continuent chaque nuit. Jaren transmet ses notes à Thade. Si les PJ tardent, Jaren meurt avant qu'ils n'aient exploité les indices.",
            actions_pj_attendues: ["examiner les dalles et les outils", "parler à Thorgar", "observer Jaren et son carnet", "demander à voir le Mausolée"],
            sorties_possibles: ["vers s1_mort_jaren (suivre la piste des outils / Jaren meurt)", "vers s1_temple_forgeron (aller voir Thorgar pour les runes)"],
            si_les_pj_bloquent: "Thorgar signale les outils d'Université si les PJ ne les remarquent pas. Si les PJ quittent le Cimetière sans rien trouver, Thade les renvoie. Le lendemain, Jaren est mort — la nouvelle les rattrape.",
            conditions_sortie: [
              "Les PJ ont identifié les outils d'Université ou le carnet de Jaren.",
              "OU les PJ ont ressenti le froid du Mausolée et veulent en savoir plus.",
              "OU les PJ quittent le Cimetière sans rien trouver — Jaren meurt le lendemain.",
            ],
            transition_defaut: "Thorgar raccompagne les PJ à la porte du Cimetière. « Revenez. Il y a encore à voir. » Le lendemain matin, un message glissé sous la porte : « Pavillon Nord. Troisième étage. Venez vite. »",
          },
        },

        {
          ...
          idsPnj: [],
          idsPnjImpliques: ["jaren_velt", "thade_coren"],
          ...
          navigation: {
            indice_indispensable: "Les PJ doivent savoir que Jaren est mort, que ce n'est pas naturel et qu'une rune est sur sa nuque.",
            consequence_si_manque: "Si les PJ n'examinent pas le corps, l'Université déclare 'mort naturelle'. Le carnet est confisqué. Les PJ doivent trouver les indices ailleurs : le cachet de Caldris via la Résistance, la rune via les publications de Thade aux Archives.",
            pnj_alternatifs: ["maera_olane — peut confirmer que la mort n'est pas naturelle si les PJ lui apportent leurs soupçons", "le_collecteur — connaît le cachet de Caldris par les égouts"],
            front_si_ignore: "Le Plan de Thade — Thade élimine les témoins sans opposition. Les Factions de la Crise — la mort attire l'attention du Champion.",
            scenes_alternatives: ["s1_archives_scellees — si les PJ vont directement chercher le dossier S-01", "s1_bureau_olane — si les PJ cherchent un allié institutionnel"],
            sorties_jouables: [
              {
                condition: "Les PJ veulent comprendre les rites et les runes d'ancrage",
                sceneId: "s1_temple_forgeron",
                type: "indice_principal",
                moteur: "La rune sur la nuque de Jaren et les runes dans les os pointent vers les rites d'Edhrek-Murn.",
                accroche_mj: "« La rune sur la nuque de Jaren ressemble aux runes que vous avez vues dans les ossements au Cimetière. Thorgar pourrait savoir ce qu'elles signifient. »",
                consequence_si_refus: "Les PJ peuvent aller aux Archives directement, mais ils manquent le cadre rituel qui donne sens aux runes.",
              },
              {
                condition: "Les PJ cherchent un allié à l'Université",
                sceneId: "s1_bureau_olane",
                type: "pnj",
                moteur: "Olane est isolée mais lucide. Elle peut confirmer les soupçons si les PJ apportent des preuves.",
                accroche_mj: "Si les PJ demandent qui d'autre pourrait les aider : « Il y a Olane. Salle 4B. Elle pose des questions que personne ne veut entendre. Mais elle ne s'ouvrira pas sans preuve. »",
                consequence_si_refus: "Sans Olane, les PJ n'ont pas d'accès institutionnel ni de couverture pour infiltrer les Archives.",
              },
              {
                condition: "Les PJ vont directement aux Archives Médicales",
                sceneId: "s1_archives_scellees",
                type: "lieu",
                moteur: "Le cachet de Caldris dans le carnet de Jaren pointe vers les dossiers médicaux.",
                accroche_mj: "Le carnet de Jaren portait un cachet de Caldris. Les Archives Médicales Scellées du Pavillon Sud pourraient contenir des dossiers liés.",
                consequence_si_refus: "Les PJ peuvent y aller plus tard avec Olane, mais l'accès sera plus difficile si Thade surveille.",
              },
              {
                condition: "Les PJ accusent Thade ouvertement sans preuve",
                sceneId: "s1_temple_forgeron",
                type: "echec",
                moteur: "L'Université fait taire les PJ par procédure. Ils perdent leur mandat.",
                accroche_mj: "Thade vous écoute avec calme. 'Je comprends vos soupçons. Mais sans preuve, c'est une accusation grave. Je vous suggère de continuer votre enquête.' L'Université ouvre une procédure de contrôle. Les PJ doivent rassembler des preuves.",
                consequence_si_refus: "Les PJ doivent trouver des preuves tangibles. La scène s1_temple_forgeron ou s1_archives_scellees devient prioritaire.",
              },
              {
                condition: "Le front 'Le Plan de Thade' avance — Thade accélère",
                sceneId: "s1_temple_forgeron",
                type: "urgence_front",
                moteur: "Une quatrième tombe est touchée. Le temps presse. Les PJ doivent comprendre le système avant qu'il ne cède.",
                accroche_mj: "Pendant que vous enquêtez, une nouvelle tombe a été profanée. Cinq sur sept maintenant. Thorgar vous envoie un message : 'Venez. C'est urgent.'",
                consequence_si_refus: "Si les PJ ignorent l'urgence, le sceau cède davantage. Le front 'Le Sceau qui cède' avance d'un segment.",
              },
              {
                condition: "Les PJ veulent fuir ou quitter Valombre",
                sceneId: "s1_temple_forgeron",
                type: "libre",
                moteur: "Les PJ sont effrayés par la mort de Jaren et veulent partir.",
                accroche_mj: "Vous pouvez partir. Mais les routes de Valombre deviennent étranges. Et Thade n'oubliera pas que vous savez quelque chose. Le MJ peut orienter vers Thorgar ou Olane comme raison de rester.",
                consequence_si_refus: "Si les PJ quittent Valombre, le déphasage s'aggrave. Ils reviennent plus tard dans une situation pire.",
              },
            ],
            fallback_mj: "La mort de Jaren ouvre trois pistes principales : Thorgar (rites), Archives (S-01), Olane (allié). Les PJ peuvent les suivre dans n'importe quel ordre. Si le carnet est confisqué, le cachet de Caldris reste accessible via le Collecteur ou les égouts plus tard.",
            objectif_scene: "Examiner le corps de Jaren, découvrir la rune sur sa nuque, le parfum de lavande, et le carnet (vide ou partiel). Comprendre que Jaren a été assassiné.",
            pression: "L'Université déclare « mort naturelle » avant midi. La garde confisque le carnet si les PJ tardent. Thade accélère ses prélèvements pendant que les PJ enquêtent.",
            actions_pj_attendues: ["examiner le corps (Médecine, Connaissances)", "fouiller le carnet de Jaren", "sentir le parfum de lavande", "décider à qui rapporter la découverte"],
            sorties_possibles: ["vers s1_temple_forgeron (comprendre les runes)", "vers s1_archives_scellees (chercher S-01)", "vers s1_bureau_olane (chercher un allié)"],
            si_les_pj_bloquent: "Si les PJ n'examinent pas le corps, l'Université déclare mort naturelle. Olane peut les alerter plus tard. Le Collecteur peut mentionner le cachet de Caldris. Une nouvelle profanation relance l'urgence.",
            conditions_sortie: [
              "Les PJ ont vu la rune sur la nuque de Jaren et le parfum de lavande.",
              "OU les PJ ont le carnet de Jaren (ou savent qu'il a été confisqué).",
              "OU les PJ quittent la scène sans rien examiner — l'Université déclare mort naturelle.",
            ],
            transition_defaut: "Les PJ quittent le Pavillon Nord. Dans le couloir, un étudiant passe sans les voir. L'air sent toujours la lavande. Dehors, le ciel est couvert. Que font les PJ ?",
          },
        },
      ],
    },
      ...
      scenes: [
        {
          ...
          navigation: {
            indice_indispensable: "Les PJ doivent comprendre que les tombes sont un système d'ancrage actif.",
            consequence_si_manque: "Sans comprendre le système d'ancrage, les PJ ne peuvent pas évaluer l'urgence du sceau. Thorgar peut réexpliquer plus tard, mais les PJ perdent du temps.",
            pnj_alternatifs: ["maera_olane — peut expliquer les runes d'ancrage avec ses données arcaniques", "le_collecteur — connaît les passages sous le Cimetière mais pas le sens des rites"],
            front_si_ignore: "Le Sceau qui cède — sans comprendre les rites, les PJ ne peuvent pas les restaurer. Le sceau continue de céder.",
            scenes_alternatives: ["s1_archives_scellees — si les PJ veulent chercher des preuves documentaires", "s1_bureau_olane — si les PJ cherchent une confirmation institutionnelle"],
            sorties_jouables: [
              {
                condition: "Les PJ veulent trouver le dossier médical de Sealine",
                sceneId: "s1_archives_scellees",
                type: "indice_principal",
                moteur: "Le cachet de Caldris et le protocole S-01 sont dans les Archives Médicales Scellées.",
                accroche_mj: "« Thorgar mentionne que les outils viennent de l'Université. Si quelqu'un a commandité ces prélèvements, il y a peut-être une trace dans les dossiers médicaux. Les Archives Scellées du Pavillon Sud. »",
                consequence_si_refus: "Les PJ peuvent y aller plus tard, mais l'accès sera plus difficile sans Olane.",
              },
              {
                condition: "Les PJ cherchent un allié institutionnel pour confirmer",
                sceneId: "s1_bureau_olane",
                type: "pnj",
                moteur: "Olane peut confirmer les détournements de flux et orienter vers la Tour.",
                accroche_mj: "« Si vous voulez comprendre qui détournes les flux arcaniques, il y a Olane. Salle 4B. Elle a les chiffres. Mais elle ne s'ouvrira pas sans preuve. »",
                consequence_si_refus: "Sans Olane, les PJ n'ont pas de couverture institutionnelle pour explorer les Archives ou la Tour.",
              },
              {
                condition: "Les PJ retournent au Cimetière pour protéger les tombes",
                sceneId: "s1_retour_cimetiere",
                type: "lieu",
                moteur: "Les PJ ont compris le système et veulent agir directement.",
                accroche_mj: "« Thorgar vous dit que les deux dernières tombes sont menacées. Si vous voulez monter la garde, venez la nuit. Mais les passages par en-dessous continuent. »",
                consequence_si_refus: "Si les PJ attendent, de nouvelles tombes sont touchées. Le front 'Le Sceau qui cède' avance.",
              },
              {
                condition: "Les PJ échouent à convaincre Thorgar de montrer les gestes",
                sceneId: "s1_archives_scellees",
                type: "echec",
                moteur: "Thorgar met les PJ sur la piste des archives et d'autres détenteurs de savoir.",
                accroche_mj: "« Thorgar ne montre pas les gestes aux non-nains. Mais il dit : 'Allez aux Archives. Cherchez les dossiers de l'année de Nyx. Et trouvez Olane. Elle pose les bonnes questions.' »",
                consequence_si_refus: "Les PJ doivent trouver les indices par d'autres voies. La piste des Archives devient prioritaire.",
              },
              {
                condition: "Le front 'Le Sceau qui cède' est à 3+ segments",
                sceneId: "s1_retour_cimetiere",
                type: "urgence_front",
                moteur: "Cinq tombes sur sept sont touchées. Le sceau est proche de la rupture.",
                accroche_mj: "« Thorgar envoie un message urgent : 'Cinq tombes. Les runes changent. Venez. Maintenant.' »",
                consequence_si_refus: "Si les PJ ignorent, le sceau cède davantage. Le déphasage commence à apparaître.",
              },
              {
                condition: "Les PJ veulent explorer les égouts ou la Vieille Ville",
                sceneId: "s1_rencontre_resistance",
                type: "libre",
                moteur: "Les PJ cherchent d'autres pistes ou contacts.",
                accroche_mj: "« La Vieille Ville est un labyrinthe. Si vous cherchez des gens qui savent ce qui se passe, commencez par les égouts. Mais faites attention. »",
                consequence_si_refus: "Les PJ peuvent trouver la Résistance plus tard, mais le réseau se replie si la crise s'aggrave.",
              },
            ],
            fallback_mj: "Le Temple-Forgeron est une scène de révélation clé. Si les PJ n'y vont pas, Thorgar peut transmettre l'info au Cimetière lors du Retour. Si les PJ n'ont jamais vu Thorgar, les rites restent un mystère et le sceau cède plus vite. Le MJ peut faire rencontrer Thorgar et les PJ au Cimetière de nuit.",
            objectif_scene: "Apprendre ce que Thorgar sait des rites d'Edhrek-Murn et comprendre que les tombes sont un système d'ancrage actif, pas un monument.",
            pression: "Les profanations continuent. Chaque jour sans comprendre le système d'ancrage, le sceau cède davantage. Si les PJ accusent sans preuve, Thorgar les fait expulser.",
            actions_pj_attendues: ["gagner la confiance de Thorgar (Diplomatie)", "lui demander de montrer les gestes rituels", "comparer les runes des os avec les runes des rites", "demander qui d'autre connaît ces rites"],
            sorties_possibles: ["vers s1_archives_scellees (chercher S-01 et le cachet de Caldris)", "vers s1_bureau_olane (chercher une confirmation institutionnelle)", "vers s1_retour_cimetiere (protéger les tombes directement)"],
            si_les_pj_bloquent: "Si les PJ ne vont pas au Temple, Thorgar peut les trouver au Cimetière de nuit. Olane peut expliquer les runes d'ancrage avec ses données. Si les PJ échouent à convaincre Thorgar, il les oriente vers les Archives et Olane.",
            conditions_sortie: [
              "Les PJ ont vu les gestes d'Edhrek-Murn et compris que les tombes sont des ancrages actifs.",
              "OU les PJ ont échoué à convaincre Thorgar et sont orientés vers les Archives et Olane.",
              "OU les PJ quittent le Temple sans comprendre — Thorgar les met sur la piste d'autres détenteurs de savoir.",
            ],
            transition_defaut: "Thorgar raccompagne les PJ à la forge. Le martèlement de l'enclume reprend. « Allez aux Archives. Cherchez les dossiers de l'année de Nyx. Et trouvez Olane. Elle pose les bonnes questions. »",
          },
        },

        {
          ...
          navigation: {
            indice_indispensable: "Les PJ doivent savoir que S-01 = Sealine et que Thade a établi ce protocole avant Nyx.",
            consequence_si_manque: "Sans le dossier S-01, les PJ ne comprennent pas le motif de Thade. Olane peut apporter cette information plus tard si les PJ lui apportent d'autres preuves. Le Collecteur peut mentionner le cachet de Caldris.",
            pnj_alternatifs: ["maera_olane — peut interpréter le dossier si les PJ le lui apportent", "le_collecteur — connaît le cachet de Caldris par les égouts"],
            front_si_ignore: "Le Plan de Thade — sans comprendre le motif, les PJ ne peuvent pas anticiper les actions de Thade. Les Factions de la Crise — le cachet mène à Elian Voss et Maelric.",
            scenes_alternatives: ["s1_bureau_olane — si les PJ apportent le dossier à Olane pour confirmation", "s1_rencontre_resistance — si les PJ cherchent le cachet de Caldris par les égouts"],
            sorties_jouables: [
              {
                condition: "Les PJ apportent le dossier S-01 à Olane",
                sceneId: "s1_bureau_olane",
                type: "indice_principal",
                moteur: "Olane fait le lien entre S-01, Thade et Nyx. Elle devient une alliée déterminée.",
                accroche_mj: "« Vous avez un dossier scellé. Olane est la seule personne qui peut le lire sans risquer une procédure. Salle 4B. Apportez-le lui. »",
                consequence_si_refus: "Sans Olane, les PJ ont le dossier mais pas de couverture institutionnelle pour l'utiliser.",
              },
              {
                condition: "Les PJ retournent voir Thorgar avec les informations du dossier",
                sceneId: "s1_retour_cimetiere",
                type: "pnj",
                moteur: "Les PJ comprennent que les os sont des ancrages et que Thade les prélève pour ouvrir le seuil.",
                accroche_mj: "« Thorgar doit savoir. Les os ne sont pas des trophées — ce sont des composants du sceau. Et quelqu'un les prend pour l'ouvrir. »",
                consequence_si_refus: "Thorgar apprendra la vérité par lui-même quand le sceau cèdera davantage. Mais le retard coûte du temps précieux.",
              },
              {
                condition: "Les PJ cherchent le cachet de Caldris dans les égouts",
                sceneId: "s1_rencontre_resistance",
                type: "lieu",
                moteur: "Le cachet de Caldris dans le dossier pointe vers un réseau extérieur. Les égouts sont le chemin des caisses.",
                accroche_mj: "« Le cachet de Caldris sur le dossier et dans les notes de Jaren. Si des caisses circulent par les égouts, quelqu'un les transporte. La Vieille Ville est le point de départ. »",
                consequence_si_refus: "Les PJ peuvent trouver la Résistance plus tard, mais le réseau d'ossements continue de fonctionner.",
              },
              {
                condition: "Les PJ échouent à déchiffrer le dossier médical",
                sceneId: "s1_bureau_olane",
                type: "echec",
                moteur: "Olane peut interpréter les notes médicales et le protocole S-01.",
                accroche_mj: "« Le dossier est technique. Vous avez le nom, la date, la mention 'littérature interdite'. Mais le contenu médical vous échappe. Olane peut le lire. »",
                consequence_si_refus: "Les PJ ont le nom de Sealine et la date, mais pas le détail du protocole. Le lien avec Nyx reste implicite.",
              },
              {
                condition: "Le front 'Le Sceau qui cède' est à 3+ segments",
                sceneId: "s1_retour_cimetiere",
                type: "urgence_front",
                moteur: "Le sceau cède pendant que les PJ enquêtent. Le temps presse.",
                accroche_mj: "Pendant que vous étudiez le dossier, un bruit sourd remonte du sol. Le bourdonnement du Puits de l'Abîme. Thorgar envoie un message : 'Cinq tombes. Venez.'",
                consequence_si_refus: "Si les PJ ignorent, le sceau cède. Le déphasage commence à apparaître dans la Vieille Ville.",
              },
              {
                condition: "Les PJ sont surpris de nuit dans les Archives",
                sceneId: "s1_bureau_olane",
                type: "libre",
                moteur: "Procédure interne. Les PJ ont besoin d'une couverture.",
                accroche_mj: "« Des pas dans le couloir. La garde de l'Université. Si vous n'avez pas d'autorisation, vous êtes en effraction. Olane peut couvrir — si vous la connaissez. »",
                consequence_si_refus: "Sans Olane, les PJ sont arrêtés. Le dossier est confisqué. Ils doivent trouver une autre voie.",
              },
            ],
            ...
            si_les_pj_bloquent: "Si les PJ n'entrent pas dans les Archives, Olane peut apporter le dossier S-01 elle-même si les PJ lui donnent assez d'indices. Le Collecteur peut mentionner le cachet de Caldris. Une urgence du front 'Le Sceau qui cède' relance l'enquête.",
            conditions_sortie: [
              "Les PJ ont lu le dossier S-01 et savent que S-01 = Sealine, protocole établi avant Nyx.",
              "OU les PJ ont une copie partielle (page de garde, mention 'littérature interdite').",
              "OU les PJ échouent à déchiffrer le dossier — Olane peut l'interpréter plus tard.",
              "OU les PJ n'entrent jamais — Olane apporte l'information plus tard.",
            ],
            transition_defaut: "Les PJ referment le dossier. L'air sec des Archives les accueille. Dehors, le couloir du Pavillon Sud est silencieux. Le nom de Sealine résonne. Que font les PJ ?",
          },
        },

        {
          ...
          navigation: {
            indice_indispensable: "Les PJ doivent savoir qu'Olane peut être une alliée si on lui apporte des preuves.",
            consequence_si_manque: "Sans Olane, les PJ n'ont pas d'accès institutionnel, pas de couverture légale, et pas de guide vers la Tour. Ils peuvent encore trouver la Résistance, mais l'institution reste un terrain hostile.",
            pnj_alternatifs: ["mara_dirigeante — peut remplacer Olane comme alliée principale, mais sans accès institutionnel", "thorgar_pretre_nain — reste un allié pour les rites, mais sans influence politique"],
            front_si_ignore: "Le Plan de Thade — sans Olane, Thade neutralise l'opposition interne à l'Université. La Cité sous pression — Olane est le pont entre l'Université et le Conseil.",
            scenes_alternatives: ["s1_retour_cimetiere — si les PJ vont directement au Cimetière sans allié institutionnel", "s1_rencontre_resistance — si les PJ cherchent des alliés hors institution"],
            sorties_jouables: [
              {
                condition: "Les PJ retournent au Cimetière pour évaluer l'état du sceau",
                sceneId: "s1_retour_cimetiere",
                type: "indice_principal",
                moteur: "Olane a dit : 'La Tour. Regardez la Tour.' Mais avant la Tour, le sceau. Cinq tombes sont touchées.",
                accroche_mj: "« Olane vous raccompagne. 'La Tour. Regardez la Tour.' Mais avant la Tour, le Cimetière. Thorgar vous attend. Le sceau cède. »",
                consequence_si_refus: "Si les PJ vont directement à la Tour sans retourner au Cimetière, ils manquent l'évaluation de l'urgence du sceau.",
              },
              {
                condition: "Les PJ cherchent la Résistance dans la Vieille Ville",
                sceneId: "s1_rencontre_resistance",
                type: "pnj",
                moteur: "Olane est un allié institutionnel. La Résistance est un allié clandestin. Les deux sont complémentaires.",
                accroche_mj: "Olane mentionne : 'Il y a des gens dans la Vieille Ville qui soignent les malades que l'Université refuse. Si vous voulez comprendre ce qui se passe, ils en savent plus que nous sur le terrain.'",
                consequence_si_refus: "Les PJ peuvent trouver la Résistance plus tard, mais sans Olane comme pont, l'alliance est plus fragile.",
              },
              {
                condition: "Les PJ veulent infiltrer la Tour Arcanique immédiatement",
                sceneId: "s1_choix",
                type: "lieu",
                moteur: "Olane a pointé vers la Tour. Les PJ veulent y aller directement.",
                accroche_mj: "'La Tour. Regardez la Tour.' Les PJ peuvent s'y rendre, mais sans préparation, sans alliés, et sans comprendre le sceau. Le MJ peut les laisser essayer — la Tour est dangereuse.",
                consequence_si_refus: "Si les PJ vont à la Tour sans préparation, ils sont repérés par Thade. La confrontation est prématurée.",
              },
              {
                condition: "Les PJ échouent à gagner la confiance d'Olane",
                sceneId: "s1_rencontre_resistance",
                type: "echec",
                moteur: "Sans Olane, les PJ doivent trouver d'autres alliés. La Résistance est l'alternative.",
                accroche_mj: "Olane reste prudente. 'Anomalies temporaires.' Elle ne confirme rien. Les PJ doivent trouver quelqu'un d'autre. La Vieille Ville. Les malades. Les égouts.",
                consequence_si_refus: "Sans allié, les PJ sont seuls. Le Scénario 2 commence avec un retard critique et moins de ressources.",
              },
              {
                condition: "Le front 'Le Sceau qui cède' est à 3+ segments",
                sceneId: "s1_retour_cimetiere",
                type: "urgence_front",
                moteur: "Le sceau cède. Olane insiste pour que les PJ agissent.",
                accroche_mj: "Olane change de ton. 'Oubliez la Tour pour l'instant. Allez au Cimetière. Thorgar a besoin de vous. Cinq tombes. Si les deux dernières tombent, tout s'effondre.'",
                consequence_si_refus: "Si les PJ ignorent, le sceau cède. Le déphasage commence.",
              },
              {
                condition: "Les PJ veulent aller au Conseil directement",
                sceneId: "s1_choix",
                type: "libre",
                moteur: "Les PJ veulent court-circuiter l'enquête et aller au Conseil.",
                accroche_mj: "Olane secoue la tête. 'Le Conseil sans preuve formelle ? Avel renverra ça en commission. Hessa fermera les Terrasses. Maelric imposera la quarantaine. Vous n'avez pas encore assez.'",
                consequence_si_refus: "Les PJ peuvent essayer, mais sans preuve formelle, le Conseil ne fait rien. La scène s1_choix devient un échec politique.",
              },
            ],
            fallback_mj: "Olane est le pont entre l'institution et la vérité. Si les PJ ne la rencontrent pas, ils perdent l'accès institutionnel mais peuvent encore trouver la Résistance. Si les PJ la compromettent, Thade la fait muter. Le Scénario 2 commence sans allié institutionnel — plus difficile mais pas impossible.",
            objectif_scene: "Gagner la confiance d'Olane en partageant des preuves, obtenir son aide institutionnelle (accès, couverture, données sur les flux détournés vers la Tour).",
            pression: "Si les PJ compromettent Olane, Thade la fait muter en moins d'une semaine. Sans Olane, les PJ n'ont pas de couverture légale. Le front 'Le Plan de Thade' avance sans opposition interne.",
            actions_pj_attendues: ["partager les indices (S-01, runes, cachet de Caldris)", "demander ce qu'elle sait sur la Tour", "demander une couverture institutionnelle", "proposer de rassembler des preuves publiques"],
            sorties_possibles: ["vers s1_retour_cimetiere (évaluer le sceau avec les données d'Olane)", "vers s1_rencontre_resistance (trouver la Résistance comme allié complémentaire)", "vers s1_choix (infiltrer la Tour immédiatement — risqué)"],
            si_les_pj_bloquent: "Si les PJ n'ont pas de preuve, Olane ne s'ouvre pas mais laisse tomber un indice. Si les PJ ne vont pas voir Olane, elle peut les trouver via Mara. La Résistance peut remplacer partiellement Olane comme alliée.",
            conditions_sortie: [
              "Les PJ ont partagé des preuves et Olane s'est ouverte — elle pointe vers la Tour.",
              "OU les PJ n'ont pas de preuve et Olane reste prudente — ils doivent trouver d'autres alliés.",
              "OU les PJ quittent le bureau sans obtenir sa confiance — la Résistance est l'alternative.",
            ],
            transition_defaut: "Olane raccompagne les PJ à la porte. Avant de les laisser partir, elle murmure : « La Tour. Regardez la Tour. » La porte se ferme. Le couloir de l'Université est silencieux.",
          },
        },
      ],
    },
      ...
      scenes: [
        {
          ...
          navigation: {
            indice_indispensable: "Les PJ doivent comprendre que cinq tombes sur sept sont touchées et que le sceau est proche de la rupture.",
            consequence_si_manque: "Sans évaluer l'urgence, les PJ ne savent pas que le temps presse. Thorgar peut envoyer un message urgent plus tard, mais le retard coûte des segments au front 'Le Sceau qui cède'.",
            pnj_alternatifs: ["maera_olane — peut confirmer l'urgence avec ses données arcaniques", "mara_dirigeante — sait que les passages sous le Cimetière sont actifs"],
            front_si_ignore: "Le Sceau qui cède — sans retour au Cimetière, les PJ ne mesurent pas l'urgence. Le front avance sans opposition.",
            scenes_alternatives: ["s1_rencontre_resistance — si les PJ cherchent la Résistance avant de retourner au Cimetière", "s1_choix — si les PJ vont directement au choix sans évaluer le sceau"],
            sorties_jouables: [
              {
                condition: "Les PJ veulent suivre les passages des égouts pour retrouver les ossements",
                sceneId: "s1_rencontre_resistance",
                type: "indice_principal",
                moteur: "Les passages creusés sous le Cimetière mènent aux égouts. La Résistance connaît ce réseau.",
                accroche_mj: "« Thorgar montre les passages. Ils descendent, ils tournent vers la Vieille Ville. Si vous voulez savoir où vont les os, suivez les tunnels. Mais les égouts ne sont pas sûrs. Trouvez quelqu'un qui les connaît. »",
                consequence_si_refus: "Les PJ peuvent explorer les égouts seuls, mais sans guide c'est dangereux et lent.",
              },
              {
                condition: "Les PJ veulent protéger les deux dernières tombes sur place",
                sceneId: "s1_choix",
                type: "lieu",
                moteur: "Les PJ restent au Cimetière pour monter la garde. Mais le temps joue contre eux.",
                accroche_mj: "« Vous pouvez rester. Mais les passages continuent. Ils viendront par en-dessous. Et vous ne pouvez pas être ici jour et nuit. Il vous faut des alliés. »",
                consequence_si_refus: "Les PJ peuvent tenir quelques nuits, mais sans alliés ni plan, les deux dernières tombes finissent par tomber.",
              },
              {
                condition: "Les PJ cherchent Olane pour confirmer l'urgence institutionnellement",
                sceneId: "s1_bureau_olane",
                type: "pnj",
                moteur: "Olane peut confirmer que les flux arcaniques correspondent à une fissuration du sceau.",
                accroche_mj: "« Si vous voulez une confirmation officielle de ce que vous ressentez, Olane a les chiffres. Elle peut prouver que le sceau cède. »",
                consequence_si_refus: "Sans confirmation d'Olane, les PJ ont seulement leur ressenti et le témoignage de Thorgar. Suffisant pour agir, mais pas pour convaincre le Conseil.",
              },
              {
                condition: "Les PJ interceptent des profanateurs sur place",
                sceneId: "s1_choix",
                type: "urgence_front",
                moteur: "Des agents de Thade viennent prélever les deux dernières tombes. Combat ou négociation.",
                accroche_mj: "« Des bruits dans les gradins inférieurs. Des pas précis, des outils. Ils sont là. Cette nuit. »",
                consequence_si_refus: "Si les PJ ne interceptent pas, les deux dernières tombes sont touchées. Le sceau cède entièrement.",
              },
              {
                condition: "Les PJ échouent à comprendre la nature du bourdonnement",
                sceneId: "s1_rencontre_resistance",
                type: "echec",
                moteur: "Thorgar met les PJ sur la piste des égouts et de la Tour.",
                accroche_mj: "« Thorgar secoue la tête. 'Je ne sais pas ce que c'est. Mais ça vient d'en-dessous. Suivez les tunnels. Trouvez ceux qui connaissent les égouts. Et regardez la Tour. Regardez-la.' »",
                consequence_si_refus: "Les PJ n'ont pas la nature planaire du phénomène, mais ils ont la direction : les égouts et la Tour.",
              },
              {
                condition: "Les PJ veulent aller au Conseil d'urgence",
                sceneId: "s1_choix",
                type: "libre",
            ...
            sorties_possibles: ["vers s1_rencontre_resistance (suivre les passages des égouts)", "vers s1_choix (protéger les tombes sur place — insuffisant sans alliés)", "vers s1_bureau_olane (confirmer l'urgence institutionnellement)"],
            si_les_pj_bloquent: "Thorgar envoie un message urgent si les PJ ne viennent pas. Olane peut confirmer l'urgence avec ses données. Si les PJ ignorent, le sceau cède entièrement et le déphasage commence. Le Scénario 2 démarre dans une situation pire.",
            conditions_sortie: [
              "Les PJ ont mesuré l'urgence : cinq tombes sur sept, le sceau est proche de la rupture.",
              "OU les PJ ont intercepté des profanateurs sur place — la scène devient un combat.",
              "OU les PJ quittent le Cimetière sans comprendre — Thorgar les met sur la piste des égouts et de la Tour.",
            ],
            transition_defaut: "Thorgar raccompagne les PJ à la porte du Cimetière. Le bourdonnement les suit jusqu'à la rue. « Suivez les tunnels. Trouvez ceux qui connaissent les égouts. Et regardez la Tour. »",
          },
        },

        {
          ...
          navigation: {
            indice_indispensable: "Les PJ doivent savoir que la Résistance existe et qu'elle a des informations sur les ossements et les passages des égouts.",
            consequence_si_manque: "Sans la Résistance, les PJ n'ont pas de guide pour les égouts, pas d'information sur les caisses de Caldris, et pas d'allié clandestin. Le Collecteur peut être trouvé plus tard, mais le réseau se replie si la crise s'aggrave.",
            pnj_alternatifs: ["maera_olane — peut orienter vers la Résistance si les PJ ne la trouvent pas seuls", "thorgar_pretre_nain — connaît les passages sous le Cimetière mais pas le réseau des égouts"],
            front_si_ignore: "Le Plan de Thade — les égouts sont le chemin des ossements. Sans les surveiller, Thade continue ses prélèvements. Les Factions de la Crise — la Résistance est un acteur de la crise.",
            scenes_alternatives: ["s1_choix — si les PJ vont directement au choix sans rencontrer la Résistance", "s1_retour_cimetiere — si les PJ retournent au Cimetière sans allié clandestin"],
            sorties_jouables: [
              {
                condition: "Les PJ acceptent l'alliance avec Mara et suivent Sniv dans les égouts",
                sceneId: "s1_choix",
                type: "indice_principal",
                moteur: "Sniv guide les PJ dans les égouts. Ils voient les passages et les caisses. La preuve est concrète.",
                accroche_mj: "Sniv tire la manche d'un PJ : 'Moi montrer passage. Os passer par dessous. Maintenant, avant que les grands reviennent.' Les égouts sentent la pierre humide et la rouille.",
                consequence_si_refus: "Si les PJ refusent de suivre Sniv, ils peuvent aller au choix sans preuve concrète des égouts.",
              },
              {
                condition: "Les PJ veulent d'abord retourner au Cimetière avec les infos de la Résistance",
                sceneId: "s1_retour_cimetiere",
                type: "pnj",
                moteur: "Les PJ ont les informations de Mara et du Collecteur. Ils retournent au Cimetière avec un nouveau regard.",
                accroche_mj: "Mara dit : 'Allez voir par vous-mêmes. Les passages sont là. Et Thorgar a besoin de savoir.'",
                consequence_si_refus: "Les PJ peuvent y aller plus tard, mais le temps presse.",
              },
              {
                condition: "Les PJ refusent l'alliance avec la Résistance",
                sceneId: "s1_choix",
                type: "echec",
                moteur: "Les PJ restent du côté de l'Université ou refusent de choisir.",
                accroche_mj: "Mara hausse les épaules. 'Revenez quand vous saurez de quel côté vous êtes.' La porte se ferme. Les PJ sont seuls.",
                consequence_si_refus: "Sans la Résistance, les PJ n'ont pas de guide ni d'allié clandestin. Le Scénario 2 commence avec moins de ressources.",
              },
              {
                condition: "Le front 'Le Sceau qui cède' est à 3+ segments",
                sceneId: "s1_choix",
                type: "urgence_front",
                moteur: "Mara insiste : le sceau cède, il faut choisir maintenant.",
                accroche_mj: "Mara change de ton. 'Oubliez les précautions. Cinq tombes. Si les deux dernières tombent, tout s'effondre. Il faut choisir maintenant.'",
                consequence_si_refus: "Si les PJ ignorent, le sceau cède. Le Scénario 2 démarre dans une situation pire.",
              },
              {
                condition: "Les PJ veulent utiliser le Collecteur pour infiltrer les égouts seuls",
                sceneId: "s1_choix",
                type: "libre",
                moteur: "Le Collecteur accepte de guider les PJ sans Mara, pour un prix.",
                accroche_mj: "Le Collecteur ouvre son carnet. 'D'accord. Mais ça a un prix. Et je ne suis pas Sniv — je connais les caisses, pas les passages.'",
                consequence_si_refus: "Sans Sniv, les égouts sont dangereux et lents à explorer.",
              },
              {
                condition: "Les PJ veulent trahir la Résistance à Thade",
                sceneId: "s1_choix",
                type: "echec",
                moteur: "Les PJ rapportent l'existence de la Résistance à Thade. Thade agit contre eux.",
                accroche_mj: "Thade vous écoute avec gravité. 'La Résistance. Je vois. Merci de m'avertir.' Son regard change. Le Scénario 2 commence avec la Résistance détruite.",
                consequence_si_refus: "La Résistance se replie. Les PJ perdent accès aux égouts et à la pègre.",
              },
            ],
            fallback_mj: "La Résistance peut être trouvée par les égouts, par un malade soigné par Ursula, ou par Olane qui oriente les PJ. Si les PJ ne la trouvent jamais, ils peuvent encore aller au choix avec les preuves de l'Université. Mais sans la Résistance, ils n'ont pas de guide ni d'allié clandestin. Le Scénario 2 commence avec moins de ressources.",
            objectif_scene: "Rencontrer la Résistance, comprendre leur rôle (soins, renseignements, égouts), et décider si les PJ s'allient avec eux ou restent du côté de l'Université.",
            pression: "Le réseau se replie si la crise s'aggrave. Si les PJ trahissent la Résistance à Thade, Mara disparaît et le réseau se replie. Le sceau continue de céder pendant les négociations.",
            actions_pj_attendues: ["parler à Mara et gagner sa confiance (Diplomatie)", "demander au Collecteur ce qu'il sait des caisses de Caldris", "demander à Sniv de montrer les passages des égouts", "comparer les infos de la Résistance avec les indices de l'Université"],
            sorties_possibles: ["vers s1_choix (suivre Sniv dans les égouts puis choisir)", "vers s1_retour_cimetiere (retourner au Cimetière avec les nouvelles infos)", "vers s1_choix (refuser l'alliance — les PJ sont seuls)"],
            si_les_pj_bloquent: "Si les PJ ne trouvent pas la Résistance, Olane peut les orienter. Un malade soigné par Ursula peut les approcher. Si les PJ refusent l'alliance, Mara les laisse partir avec un moyen de contact. Le front 'Le Sceau qui cède' relance l'urgence.",
            conditions_sortie: [
              "Les PJ ont accepté l'alliance avec Mara et Sniv les guide vers les égouts.",
              "OU les PJ refusent l'alliance et quittent la Maison des Retours.",
              "OU les PJ trahissent la Résistance à Thade — le réseau se replie.",
              "OU les PJ demandent du temps — Mara les laisse partir avec un moyen de contact.",
            ],
            transition_defaut: "Sniv tire la manche d'un PJ : 'Moi montrer passage. Os passer par dessous. Maintenant, avant que les grands reviennent.' Les égouts attendent. Que font les PJ ?",
          },
        },

        {
          ...
          navigation: {
            indice_indispensable: "Les PJ doivent comprendre que Thade prélève les os pour ouvrir le seuil et qu'ils doivent choisir leur camp.",
            consequence_si_manque: "Si les PJ n'ont pas assez d'indices pour comprendre, Mara et Thorgar résument la situation. Le choix est forcé même avec une compréhension partielle.",
            pnj_alternatifs: ["maera_olane — peut être présente si les PJ l'ont recrutée comme alliée", "le_collecteur — peut apporter des preuves supplémentaires des égouts"],
            front_si_ignore: "Tous les fronts — le choix détermine quelles horloges avancent. Refuser de choisir fait avancer toutes les horloges.",
            scenes_alternatives: [],
            sorties_jouables: [
              {
                condition: "Les PJ choisissent de rejoindre la Résistance et de protéger le sceau",
                sceneId: "s2_emeute_place",
                type: "indice_principal",
                moteur: "Le Scénario 2 commence. Les PJ sont alliés avec la Résistance. L'Université est un terrain hostile.",
                accroche_mj: "« Mara vous tend la main. 'Bienvenue. Maintenant au travail. Les caisses passent cette nuit. Sniv vous guide.' Le Scénario 2 commence. »",
                consequence_si_refus: "Ce choix ouvre le Scénario 2 avec la Résistance comme alliée principale.",
              },
              {
                condition: "Les PJ choisissent de rapporter à Thade",
                sceneId: "s2_emeute_place",
                type: "echec",
                moteur: "Le Scénario 2 commence avec un retard critique. Les PJ sont les outils de Thade.",
                accroche_mj: "« Thade vous reçoit avec gratitude. 'Merci. Vous avez fait le bon choix.' Mais dans ses yeux, quelque chose a changé. Il sait que vous avez vu la Résistance. Le Scénario 2 commence. »",
                consequence_si_refus: "Ce choix ouvre le Scénario 2 avec Thade comme mentor et la Résistance affaiblie.",
              },
              {
                condition: "Les PJ choisissent de confronter Thade directement",
                sceneId: "s2_emeute_place",
                type: "lieu",
                moteur: "Le Scénario 2 commence avec une confrontation ouverte. Thade est un adversaire déclaré.",
                accroche_mj: "« Thade vous écoute. Il ne nie pas. Il explique. Et il dit : 'Je peux refermer le seuil. Mais il me faut les os.' Le Scénario 2 commence. »",
                consequence_si_refus: "Ce choix ouvre le Scénario 2 avec Thade comme adversaire et sans allié institutionnel.",
              },
              {
                condition: "Les PJ refusent de choisir et demandent du temps",
                sceneId: "s2_emeute_place",
                type: "urgence_front",
                moteur: "Le temps passe. Le sceau cède. Une sixième tombe tombe. Le choix devient plus urgent.",
                accroche_mj: "Mara vous laisse partir. 'Le temps n'est pas votre allié.' Le lendemain, une sixième tombe est touchée. Le bourdonnement est plus fort. Le Scénario 2 commence avec plus de pression et moins d'alliés.",
                consequence_si_refus: "Le Scénario 2 démarre dans une situation pire. Le front 'Le Sceau qui cède' a un segment d'avance.",
              },
              {
                condition: "Les PJ proposent une troisième voie (négocier avec Thade ET protéger les tombes)",
                sceneId: "s2_emeute_place",
                type: "libre",
              ...
              {
                condition: "Les PJ veulent aller au Conseil avec toutes les preuves",
                sceneId: "s2_emeute_place",
                type: "libre",
            ...
            fallback_mj: "Le Choix est un pivot narratif qui ne peut pas être évité. Si les PJ refusent, le temps passe et le sceau cède. Le Scénario 2 commence dans tous les cas — le choix détermine les conditions de départ : alliés, ennemis, pression du sceau, position institutionnelle.",
            objectif_scene: "Choisir le camp des PJ : servir Thade, le confronter, ou protéger le sceau avec la Résistance. Ce choix définit les conditions de départ du Scénario 2.",
            pression: "Le sceau cède. Chaque jour sans choix, une tombe de plus tombe. Si les PJ refusent de choisir, toutes les horloges avancent. Le Scénario 2 commence avec plus de pression et moins d'alliés.",
            actions_pj_attendues: ["écouter Mara et Thorgar exposer la situation", "débattre entre PJ des options", "choisir : Résistance, Thade, confrontation directe, ou troisième voie", "éventuellement demander du temps (avec conséquences)"],
            sorties_possibles: ["vers s2_emeute_place (rejoindre la Résistance)", "vers s2_emeute_place (rapporter à Thade)", "vers s2_emeute_place (confronter Thade)", "vers s2_emeute_place (refuser de choisir — le temps passe)"],
            si_les_pj_bloquent: "Si les PJ refusent de choisir, Mara les laisse partir mais prévient : « Le temps n'est pas votre allié. » Le lendemain, une sixième tombe est touchée. Le choix devient plus urgent. Le Scénario 2 commence avec plus de pression.",
            conditions_sortie: [
              "Les PJ ont choisi de rejoindre la Résistance.",
              "OU les PJ ont choisi de rapporter à Thade.",
              "OU les PJ ont choisi de confronter Thade directement.",
              "OU les PJ ont proposé une troisième voie (négocier ET protéger).",
              "OU les PJ refusent de choisir — le temps passe, le sceau cède, le Scénario 2 commence avec plus de pression.",
            ],
            transition_defaut: "Mara et Thorgar se taisent. Le bruit de l'eau dans les égouts est le seul son. Les PJ quittent la salle. Le lendemain, une sixième tombe est touchée. Le bourdonnement est plus fort. Le Scénario 2 commence.",
          },
        },
      ],
    },
